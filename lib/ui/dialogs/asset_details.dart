        ...
        child: AnimatedSwitcher(
          ...
          child: SizedBox.expand(
            ...
            child: Stack(fit: StackFit.expand, children: [
              ...
              // status bar like the web mockup
              Positioned(
                top: 6,
                left: 18,
                right: 18,
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text(_lockOn ? '' : '9:41', style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w700, shadows: [Shadow(color: Colors.black.withValues(alpha: 0.6), blurRadius: 4)])),
                  Row(children: [
                    Fa('fa-signal', size: 9, color: Colors.white),
                    const SizedBox(width: 4),
                    Fa('fa-wifi', size: 9, color: Colors.white),
                    const SizedBox(width: 4),
                    Fa('fa-battery-three-quarters', size: 9, color: Colors.white),
                  ]),
                ]),
              ),
              Positioned(
