      ...
      builder: (context, cand, rej) => AnimatedContainer(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          Container(
            ...
            child: Row(children: [
              Fa(ui.icon, size: 11, color: p.onPrimary),
              const SizedBox(width: 6),
              Expanded(child: Text(ui.label + (d.switchedFrom != null ? ' (from ${kDayTypeUi[d.switchedFrom!]?.short ?? d.switchedFrom})' : ''), style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: p.onPrimary), maxLines: 1, overflow: TextOverflow.ellipsis)),
              Text('0–14 min delay · Dhaka', style: TextStyle(fontSize: 9.5, color: p.onPrimary.withValues(alpha: 0.85))),
            ]),
          ),
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 6),
              Text('Click to pin a file${noneHave ? ' · no type has 3 files' : ''}', style: TextStyle(fontSize: 11.5, color: p.muted)),
              runMeta(false),
            ]),
          ),
        ),
