...
class FirebaseRtdb {
  ...
  Stream<dynamic> stream(String path) {
    ...
    Future<void> connect() async {
      while (!closed) {
        ...
        try {
          final req = http.Request('GET', _uri(path))..headers['Accept'] = 'text/event-stream';
          req.followRedirects = true;
          final res = await sseClient!.send(req).timeout(const Duration(seconds: 30));
