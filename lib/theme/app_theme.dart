...
class Zc {
  ...
  static const Color lemon = Color(0xFFFFF176);
  ...
  static const LinearGradient secondaryGradient = LinearGradient(
    ...
    colors: <Color>[Color(0xFF2F7DD1), Color(0xFF7C3AED)],
  );

  static const LinearGradient accentGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: <Color>[Color(0xFFFF8A00), Color(0xFFE0457B)],
  );

  static const LinearGradient successGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: <Color>[Color(0xFF22C55E), Color(0xFF15803D)],
  );

  static const LinearGradient dangerGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: <Color>[Color(0xFFF87171), Color(0xFFB91C1C)],
  );
  ...
  /// Accent colour per content type (matches the web dashboard badges).
  static Color typeColor(String contentType) {
    switch (contentType) {
      case 'AUDIO':
      case 'RINGTONE':
        return purple;
...
/// Stronger shadow for hovered / lifted cards and drag feedback.
const List<BoxShadow> kLiftShadow = <BoxShadow>[
  BoxShadow(color: Color(0x22211D12), blurRadius: 6, offset: Offset(0, 3)),
  BoxShadow(color: Color(0x2E4C3C14), blurRadius: 24, offset: Offset(0, 12)),
  BoxShadow(color: Color(0x1A4C3C14), blurRadius: 48, offset: Offset(0, 24)),
];
