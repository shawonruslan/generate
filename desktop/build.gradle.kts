    ...
    application {
        ...
        nativeDistributions {
            ...
            windows {
                ...
                shortcut = true
                dirChooser = true
                // v31: per-machine install (UAC prompt). The per-user MSI ran Windows Installer without elevation and
                // failed on many PCs with error 2503/2502 (no write access to C:\Windows\Temp). Elevated installs do not hit this.
                // App data still lives in %APPDATA%\MetaHawladar, so nothing else changes.
