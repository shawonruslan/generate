...
/** Where the Windows app keeps its data: %APPDATA%\ZedgeContentStudio (fallback: ~/.zedge-content-studio). */
object Storage {
    val baseDir: File by lazy {
        val appData = System.getenv("APPDATA")
        val dir = if (!appData.isNullOrBlank()) File(appData, "ZedgeContentStudio") else File(System.getProperty("user.home"), ".zedge-content-studio")
        dir.mkdirs(); dir
    }
